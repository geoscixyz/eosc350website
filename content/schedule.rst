...
|     |   |  ||               |                             |-  TBL review                      |                              |              |
+     +---+  +----------------+-----------------------------+-----------------------------------+                              |              |
|     | 11|  || GPR           | - `GPG GPR`_                |-  `GPR lecture 1`_                |                              |              |
...
|     |   |  ||               |- `EM Loops App`_            |- `EM lecture 1`_                  |                              |              |
|     |   |  ||               |- `EM Pipe App`_             |                                   |                              |              |
|     |   |  ||               |- `EM 31 App`_               |                                   |                              |              |
+-----+---+--+----------------+-----------------------------+-----------------------------------+------------------------------+--------------+
|     | 4 |10|| EM            |                             |- `EM lecture 2`_                  | - `Lab 8 EM 1`_              |              |
|     |   |  ||               |                             |                                   |                              |              |
|     |   |  ||               |                             |                                   |                              |              |
+     +---+  +----------------+-----------------------------+-----------------------------------+                              |              |
|     | 6 |  || EM            |                             |- `EM lecture 3`_                  |                              |              |
...
.. _EM Loops App: https://mybinder.org/v2/gh/geoscixyz/gpgLabs/master?filepath=notebooks%2Fem%2FFDEM_3loop.ipynb
